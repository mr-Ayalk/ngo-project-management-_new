...
export const api = {
  ...
  reportPlanComparison: (id) => request(`/reports/${id}/plan-comparison`),
  ...
  uploadDocumentFile: async (file, thumbnailBlob = null) => {
  ...
  login: (email, password, location) =>
    request('/auth/login', { method: 'POST', body: JSON.stringify({ email, password, location }) }),
